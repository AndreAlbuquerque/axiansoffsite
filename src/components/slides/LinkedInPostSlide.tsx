    ...
    <div className="w-full h-full flex flex-col items-center justify-center bg-slide-bg p-12">
      ...
      >
        ...
        <div className="p-4 flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Building Cursor</p>
              <p className="text-gray-500 text-xs flex items-center gap-1">
                1d • 
                <svg className="w-3 h-3" viewBox="0 0 16 16" fill="currentColor">
                  <path d="M8 0a8 8 0 108 8 8 8 0 00-8-8zm3.85 12.15l-4.6-3.07a.48.48 0 01-.25-.42V3.5a.5.5 0 011 0v4.94l4.35 2.9a.5.5 0 01-.5.81z"/>
                </svg>
              </p>
            </div>
          </div>
          <button className="text-[#0a66c2] font-semibold text-sm flex items-center gap-1 hover:bg-blue-50 px-2 py-1 rounded">
            + Follow
          </button>
        </div>
        ...
        <div className="px-4 pb-3">
          <p className="text-gray-900">Watch Cursor build a 3M+ line browser in a week</p>
        </div>
        ...
        <div className="p-3 flex items-center justify-around border-t border-gray-200">
          <button className="flex items-center gap-2 text-gray-600 text-sm hover:bg-gray-100 px-4 py-2 rounded">
