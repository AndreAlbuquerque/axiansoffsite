...
const CodeWindowSlide = () => {
  return (
    <div className="w-full h-full flex flex-col bg-slide-bg p-12 items-center justify-center">
      <motion.h1 
      ...
      <motion.p
        className="text-muted-foreground text-xl mb-8 text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
            ...
            <code>
              {codeSnippet.split('\n').map((line, i) => (
                <motion.div 
                  ...
                  className="flex"
                >
                  <span className="text-gray-500 w-8 flex-shrink-0 select-none">{i + 1}</span>
                  <span className={`${
      ...
      <motion.p
        className="text-muted-foreground text-lg mt-6 text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
